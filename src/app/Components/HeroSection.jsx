    ...
    <div className=" border-b">
      <section className="flex min-h-[700px]  w-full items-center justify-center px-8">
        <div className="flex w-full max-w-6xl gap-10 lg:flex-row flex-col items-center justify-between relative">
          <div className=" absolute top-0 left-0 bg-purple-500 rounded-full w-52 h-52 md:w-72 md:h-72 -z-10 filter blur-2xl opacity-50 animate-pulse"></div>
          ...
          <div className=" absolute bottom-0 right-0 bg-pink-500 rounded-full w-72 h-72 -z-10 filter blur-2xl opacity-50 animate-pluse"></div>
          <div className="max-w-md md:space-y-6 sm:space-y-5 space-y-4">
            ...
            <div className="">
              <Link
                href="/mentors"
                className="w-[100%] btn hover:bg-skin-button-muted-hover rounded-lg bg-skin-fill px-6 py-2 font-medium text-white md:w-[100%]"
              >
                Get Sterted
              </Link>
            </div>
